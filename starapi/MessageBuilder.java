...
public class MessageBuilder {
    ...
    public static TextComponent buildHoverText(TextComponent baseComponent, String hoverText) {
        baseComponent.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent[]{new TextComponent(hoverText)}));
    ...
    public static TextComponent buildEntityText(String text, EntityType entityType) {
        TextComponent component = new TextComponent(text);
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_ENTITY, new BaseComponent[]{new TextComponent("{id:\"minecraft:" + entityType.getKey().getKey() + "\"}")}));
        return component;
    }
