...
public class BossBarBuilder {
    ...
    public BossBarBuilder create(Player player) {
        BossBar bossBar = Bukkit.createBossBar(MessageUtils.hex(this.title), this.color, this.style != null ? this.style : BarStyle.SOLID, this.flags);
    ...
    public BossBarBuilder update(Player player) {
        ...
        if (bossBar != null) {
            bossBar.setTitle(MessageUtils.hex(this.title));
